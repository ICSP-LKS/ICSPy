...
class AuNSMicelleModel(AbstractModel):
    
    def __init__(self,pars,name="AuNSMicelle",model_info='core_shell_sphere+core_shell_ellipsoid@hayter_msa'):
...
if __name__ == '__main__':
    ...
    fitModel = AuNSMicelleModel(pars)
    fitModel.plot(data)
    str_out = ""
