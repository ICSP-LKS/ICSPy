...
class AuNRMicelleModel(AbstractModel):
    
    def __init__(self,pars,name="AuNRMicelle",model_info='core_shell_cylinder+core_shell_ellipsoid@hayter_msa'):
    ...
    def calc_num(self):
        ...
        num.append(calcRodNum(self.pars['A_scale'],self.pars['A_radius'],self.pars['A_length'],self.pars['A_thickness']))
...
if __name__ == '__main__':
    ...
    fitModel = AuNRMicelleModel(pars)
    fitModel.plot(data)
    str_out = ""
